...
Imagem do processo de cadastro de novos moradores (AS-IS)
...
Imagem do processo de gerenciamento de avisos (AS-IS)
...
Imagem do processo de enquetes de votação de novos projetos e melhorias (AS-IS)
...
Imagem do processo de calendário de eventos e confirmação dos moradores que participarão (AS-IS)
...
Imagem do processo de gerenciar reservas de espaço de áreas de lazer (AS-IS)
...
Imagem do processo de cadastro de moradores (TO-BE)
...
Imagem do processo de avisos (TO-BE)
...
Imagem do processo de melhorias (TO-BE)
...
Imagem do processo de enquetes de votação (TO-BE)
...
Imagem do processo de gerenciar eventos (TO-BE)
...
Imagem do processo de confirmação dos moradores (TO-BE)
...
Imagem do processo de gerenciar reserva de áreas de lazer (TO-BE)
